...
Ссылки на авиамаршруты из поискового индекса должны точно совпадать с кодами
запрошенных аэропортов или городов: Пулково и поиск по всем аэропортам Москвы
не заменяют SVO. Индекс не подтверждает цену и наличие на дату. После видимой
блокировки Ozon Travel другой браузер не запускается; индекс может вернуть
только подходящую ссылку на маршрут.
